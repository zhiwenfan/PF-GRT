...
class IBRNetCollectedDataset(Dataset):
    def __init__(self, args, mode, random_crop=True, **kwargs):
        self.folder_path1 = "/ssd1/wyc/GNT/data/ibrnet_collected_1/"
        self.folder_path2 = "/ssd1/wyc/GNT/data/ibrnet_collected_2/"
        ...
        print("IBRNetCollectedDataset",len(all_scenes))

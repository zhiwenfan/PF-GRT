...
def render_rays(
    ...
    :param use_depth: if True, will use depth groudtruth as supervision
    ...
    # print('rgb_feat',torch.isnan(rgb_feat).any())
    # print('ray_diff',torch.isnan(ray_diff).any())
    ...
    if use_depth:
        ret["outputs_coarse"] = {"rgb": rgb, "weights": weights, "depth": depth_map,"weights_pred": weight_pred, "depth_pred": depth_pred}
    else:

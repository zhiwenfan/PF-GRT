...
def config_parser():
    ...
    # general
    parser.add_argument("--config",  default="configs/gnt_full.txt",is_config_file=True, help="config file path")
    ...
    parser.add_argument(
        "--ckpt_path",
        type=str,
        default="model_720000.pth",
        # default="room_model_250000.pth",
    ...
    parser.add_argument("--n_iters", type=int, default=700000, help="num of iterations")
    parser.add_argument(
    ...
    #hanxue
    parser.add_argument(
        "--load_depth", action="store_true", help="whether train with depth supervision or not"
    )
